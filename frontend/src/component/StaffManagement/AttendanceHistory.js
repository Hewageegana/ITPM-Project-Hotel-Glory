...
function AttendanceHistory() {
    ...
    function onPresent() {
        axios.get(`/staff/allpresent/${date}`).then((res) => {
    ...
    function onAbsent() {
        axios.get(`/staff/allabsent/${date}`).then((res) => {
            setAttendence(res.data);
            setIsPresent(false)
        });
    }
        ...
        <>
            ...
            <div className="container filmpage customcon">
                ...
                <div className="col-md-6 form-floating">
                    ...
                    /><label for="floatingInput">Date</label></div> &nbsp;&nbsp;
                <button type="button" className="btnregister" onClick={() => onPresent()} id="regsubmit">View Present</button>&nbsp;&nbsp;
                <button type="submit" className="btnreset" onClick={(e) => onAbsent(e)} id="regreset">View Absent</button>
                <br />
                <input
                            ...
                            <div className="row g-3">
                                ...
                                <div className="column filmpage-namecol">
                                    <h3 style={{ margin: "20px", fontWeight: "700" }}>
                                        Select Date For see Attendance History
                                    </h3>
                                    {/* <center>
                  <p>
                                        ...
                                        <div className="row g-3">
                                            ...
                                            <div className="column history-btncol">
                                                <div className="markBtn">
                                                    {isPresent === true ?
                                                        <div className="presentCover">
                                                            <h2 className="presentText">Present</h2>
                                                        </div> :
