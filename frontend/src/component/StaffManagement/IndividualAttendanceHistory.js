...
function IndividualAttendanceHistory() {
    ...
    useEffect(() => {
        const getAttendance = async () => {
            const res = await axios.get(`/staff/allNicpresent/${nic}`).then((res) => {
        ...
        <>
            ...
            <div className="container filmpage customcon">
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page">Present</a>
                    </li>
                    <li class="nav-item">
                        <Link to={"/staff/oneabsent/" + nic} class="nav-link">Absent</Link>
                    </li>
                </ul>
                <input
