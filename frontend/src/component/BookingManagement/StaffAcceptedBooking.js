...
export default function StaffAcceptedBooking() {
    ...
    const deletebooking = (id) => {
        swal({
            ...
            if (willDelete) {
                axios.delete(`/booking/deleteaccepted/${id}`).then(() => {
                    if (willDelete) {
    ...
    useEffect(() => {
        const getbooking = async () => {
            const res = await axios.get("/booking/acceptedbookingstaffview").then((res) => {
    ...
    return (
        ...
        <>
            ...
            <div className="Container">
                ...
                {acceptedBooking.map(function (f) {
                    return (
